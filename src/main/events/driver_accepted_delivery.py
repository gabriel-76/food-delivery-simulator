...
class DriverAcceptedDelivery(OrderEvent):
    def __init__(self, order_id, customer_id, establishment_id, driver_id, distance, time):
        super().__init__(order_id, customer_id, establishment_id, time, EventType.DRIVER_ACCEPTED_DELIVERY)
