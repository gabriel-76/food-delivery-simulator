...
class EstimatedOrderPreparationTime(OrderEvent):
    def __init__(self, order_id, customer_id, restaurant_id, estimated_time, time):
        super().__init__(order_id, customer_id, restaurant_id, time, EventType.ESTIMATED_ORDER_PREPARATION_TIME)
