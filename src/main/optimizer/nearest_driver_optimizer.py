...
class NearestDriverOptimizer(Optimizer):
    ...
    def compare_distance(self, env: DeliveryEnvironment, driver: DriverActor, route: Route):
        return env.map.distance(driver._coordinate, route._segments[0]._coordinate)
